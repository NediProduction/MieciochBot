...
module.exports = {
	...
	async execute(interaction) {
		const embed = new EmbedBuilder()
			.setColor('#2f3136')
			.setTitle('Ustaw kanał Powitalny')
			.setDescription('Poniżej znajdziesz listę wszystkich swoich kanałów. Wybierz jeden, na którym mam witać nowych użytkowników! \n\n*Wybrany kanał się nie wyświetla? Uruchom to polecenie na kanale, o którym myślisz, aby zobaczyć go na liście!*');
